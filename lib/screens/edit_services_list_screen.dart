// edit_services_list_screen.dart
import 'package:flutter/material.dart';
import 'package:graphql_flutter/graphql_flutter.dart';

class EditServicesListScreen extends StatelessWidget {
          ...
          return ListView.builder(
            ...
            itemBuilder: (_, i) {
              ...
              return ListTile(
                ...
                onTap: () => _showEditDialog(context, s['id'], s['name'], s['durationMinutes']),
              );
            },
          );
        },
  ...
  void _showEditDialog(BuildContext context, String id, String name, int currentDuration) {
          ...
          Mutation(
            ...
            builder: (runMutation, result) {
              return TextButton(
                ...
                child: const Text('Spremi', style: TextStyle(color: Color(0xFFC3F44D))),
              );
            },
          ),
        ],
